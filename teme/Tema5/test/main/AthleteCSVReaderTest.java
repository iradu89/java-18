...
class AthleteCSVReaderTest {
    ...
    @Test
    public void test_read_from_file_with_correct_input() {
    ...
    @Test
    public void test_read_from_file_string_instead_of_int() {
    ...
    @Test
    public void test_read_from_file_double_instead_of_int() {
        System.setOut(new PrintStream(outContent));
    ...
    @Test
    public void test_read_from_file_not_enough_fields() {
        System.setOut(new PrintStream(outContent));
    ...
    @Test
    public void test_string_name_contains_only_letters_and_spaces() {
        System.setOut(new PrintStream(outContent));
    ...
    @Test
    public void test_string_countryCode_contains_only_capital_letters() {
        System.setOut(new PrintStream(outContent));
    ...
    @Test
    public void test_string_countryCode_contains_max_three_capital_letters() {
        System.setOut(new PrintStream(outContent));
    ...
    @Test
    public void test_skiTimeResult_contains_only_ints() {
        System.setOut(new PrintStream(outContent));
    ...
    @Test
    public void test_shootingRangeResult_contains_only_x_or_o() {
        System.setOut(new PrintStream(outContent));
